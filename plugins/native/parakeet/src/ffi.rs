...
//! FFI bindings to sherpa-onnx C API for Parakeet TDT transducer
//! Based on https://github.com/k2-fsa/sherpa-onnx/blob/master/sherpa-onnx/c-api/c-api.h
//! Struct layout matches sherpa-onnx v1.12.17.
...
/// Transducer model config (encoder + decoder + joiner)
/// This is the primary model config used for Parakeet TDT.
#[repr(C)]
...
/// SenseVoice model config (unused, but needed for struct layout)
#[repr(C)]
