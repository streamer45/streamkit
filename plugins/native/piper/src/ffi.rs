...
//! Manual FFI bindings to Sherpa-ONNX C API for VITS/Piper models
//! Based on https://github.com/k2-fsa/sherpa-onnx/blob/master/sherpa-onnx/c-api/c-api.h

// Allow: FFI types/functions reserved for future use
#![allow(dead_code)]
...
/// VITS model configuration (what we use for Piper)
#[repr(C)]
...
/// Placeholder for Kokoro model config (not used, but needed for struct layout)
#[repr(C)]
