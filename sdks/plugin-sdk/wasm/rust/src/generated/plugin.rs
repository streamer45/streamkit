...
pub mod streamkit {
  pub mod plugin {
    ...
    pub mod types {
      ...
      impl ::core::fmt::Debug for AudioFormat {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
          f.debug_struct("AudioFormat").field("sample-rate", &self.sample_rate).field("channels", &self.channels).field("sample-format", &self.sample_format).finish()
        }
      }
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
          match self {
            ...
            PacketType::OpusAudio => {
              f.debug_tuple("PacketType::OpusAudio").finish()
            }
            PacketType::Text => {
              f.debug_tuple("PacketType::Text").finish()
            }
            PacketType::Binary => {
              f.debug_tuple("PacketType::Binary").finish()
            }
            PacketType::Custom(e) => {
              f.debug_tuple("PacketType::Custom").field(e).finish()
            }
            PacketType::Any => {
              f.debug_tuple("PacketType::Any").finish()
            }
          }
        }
      }
      ...
      impl ::core::fmt::Debug for CustomEncoding {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
          match self {
            CustomEncoding::Json => {
              f.debug_tuple("CustomEncoding::Json").finish()
            }
          }
        }
      }
      ...
      impl ::core::fmt::Debug for CustomPacket {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
          f.debug_struct("CustomPacket").field("type-id", &self.type_id).field("encoding", &self.encoding).field("data", &self.data).finish()
        }
      }
      ...
      impl ::core::fmt::Debug for InputPin {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
          f.debug_struct("InputPin").field("name", &self.name).field("accepts-types", &self.accepts_types).finish()
        }
      }
      ...
      impl ::core::fmt::Debug for OutputPin {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
          f.debug_struct("OutputPin").field("name", &self.name).field("produces-type", &self.produces_type).finish()
        }
      }
      /// Node metadata
      #[derive(Clone)]
      ...
      impl ::core::fmt::Debug for NodeMetadata {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
          f.debug_struct("NodeMetadata").field("kind", &self.kind).field("inputs", &self.inputs).field("outputs", &self.outputs).field("param-schema", &self.param_schema).field("categories", &self.categories).finish()
        }
      }
      /// Audio frame data
      #[derive(Clone)]
      ...
      impl ::core::fmt::Debug for AudioFrame {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
          f.debug_struct("AudioFrame").field("sample-rate", &self.sample_rate).field("channels", &self.channels).field("samples", &self.samples).finish()
        }
      }
      ...
      impl ::core::fmt::Debug for Packet {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
          match self {
            Packet::Audio(e) => {
              f.debug_tuple("Packet::Audio").field(e).finish()
            }
            Packet::Text(e) => {
              f.debug_tuple("Packet::Text").field(e).finish()
            }
            Packet::Binary(e) => {
              f.debug_tuple("Packet::Binary").field(e).finish()
            }
            Packet::Custom(e) => {
              f.debug_tuple("Packet::Custom").field(e).finish()
            }
          }
        }
      }
    ...
    pub mod host {
      ...
      pub async fn send_output(pin_name: _rt::String,packet: Packet,) -> Result<(),_rt::String>{
        unsafe {
          ...
          *mut u8, 
          ...
          unsafe impl<'a> _Subtask for _MySubtask<'a> {
            ...
            type Params = (_rt::String, Packet, );
            type Results = Result<(),_rt::String>;
            type ParamsLower = ParamsLower;
            fn abi_layout(&mut self) -> ::core::alloc::Layout {
              unsafe {
                ::core::alloc::Layout::from_size_align_unchecked((11*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>())
              }
            }
            ...
            unsafe fn call_import(&mut self, _params: Self::ParamsLower, _results: *mut u8) -> u32 {
              ...
              #[link(wasm_import_module = "streamkit:plugin/host@0.2.0")]
              unsafe extern "C" {
                #[link_name = "[async-lower]send-output"]
            ...
            unsafe fn params_dealloc_lists(&mut self, _params: Self::ParamsLower) {
              ...
              let l2 = i32::from(*_params.0.add(2*::core::mem::size_of::<*const u8>()).cast::<u8>());
              match l2 {
                0 => {
                  let l3 = *_params.0.add(8+3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                  let l4 = *_params.0.add(8+4*::core::mem::size_of::<*const u8>()).cast::<usize>();
                  let base5 = l3;
                  let len5 = l4;
                  _rt::cabi_dealloc(base5, len5 * 4, 4);
                },
                1 => {
                  let l6 = *_params.0.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                  let l7 = *_params.0.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>();
                  _rt::cabi_dealloc(l6, l7, 1);
                },
                2 => {
                  let l8 = *_params.0.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                  let l9 = *_params.0.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>();
                  let base10 = l8;
                  let len10 = l9;
                  _rt::cabi_dealloc(base10, len10 * 1, 1);
                },
                _ => {
                  let l11 = *_params.0.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                  let l12 = *_params.0.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>();
                  _rt::cabi_dealloc(l11, l12, 1);
                  let l13 = *_params.0.add(6*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                  let l14 = *_params.0.add(7*::core::mem::size_of::<*const u8>()).cast::<usize>();
        ...
        unsafe { use super::super::super::streamkit::plugin::types::Packet as V7;
        match _lower1 {
          V7::Audio(e) => {
            *_param_ptr.add(0).cast::<u8>() = (0i32) as u8;
            let super::super::super::streamkit::plugin::types::AudioFrame{ sample_rate:sample_rate0, channels:channels0, samples:samples0, } = e;
            *_param_ptr.add(::core::mem::size_of::<*const u8>()).cast::<i32>() = _rt::as_i32(sample_rate0);
            *_param_ptr.add(4+1*::core::mem::size_of::<*const u8>()).cast::<u16>() = (_rt::as_i32(channels0)) as u16;
            let vec1 = <_ as Into<_rt::Vec<_>>>::into(samples0).into_boxed_slice();
            let ptr1 = vec1.as_ptr().cast::<u8>();
            let len1 = vec1.len();
            ::core::mem::forget(vec1);
            *_param_ptr.add(8+2*::core::mem::size_of::<*const u8>()).cast::<usize>() = len1;
            *_param_ptr.add(8+1*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr1.cast_mut();
          },
          V7::Text(e) => {
            ...
            *_param_ptr.add(2*::core::mem::size_of::<*const u8>()).cast::<usize>() = len2;
            *_param_ptr.add(::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr2.cast_mut();
          },
          V7::Binary(e) => {
            ...
            *_param_ptr.add(2*::core::mem::size_of::<*const u8>()).cast::<usize>() = len3;
            *_param_ptr.add(::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr3.cast_mut();
          },
          V7::Custom(e) => {
            *_param_ptr.add(0).cast::<u8>() = (3i32) as u8;
            let super::super::super::streamkit::plugin::types::CustomPacket{ type_id:type_id4, encoding:encoding4, data:data4, } = e;
            let vec5 = (type_id4.into_bytes()).into_boxed_slice();
            let ptr5 = vec5.as_ptr().cast::<u8>();
            let len5 = vec5.len();
            ::core::mem::forget(vec5);
            *_param_ptr.add(2*::core::mem::size_of::<*const u8>()).cast::<usize>() = len5;
            *_param_ptr.add(::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr5.cast_mut();
            *_param_ptr.add(3*::core::mem::size_of::<*const u8>()).cast::<u8>() = (encoding4.clone() as i32) as u8;
            let vec6 = (data4.into_bytes()).into_boxed_slice();
            let ptr6 = vec6.as_ptr().cast::<u8>();
            let len6 = vec6.len();
            ::core::mem::forget(vec6);
            *_param_ptr.add(5*::core::mem::size_of::<*const u8>()).cast::<usize>() = len6;
            *_param_ptr.add(4*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr6.cast_mut();
          },
        }
      }
      ParamsLower(_ptr,)
  ...
  _MySubtask { _unused: core::marker::PhantomData }.call((pin_name, packet,)).await
}
}
#[allow(unused_unsafe, clippy::all)]
...
pub mod wasi {
  pub mod cli {
    ...
    pub mod environment {
      ...
      pub fn get_environment() -> _rt::Vec::<(_rt::String,_rt::String,)>{
        unsafe {
          ...
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "wasi:cli/environment@0.3.0-rc-2026-03-15")]
          unsafe extern "C" {
    ...
    pub mod stdin {
      ...
      pub fn read_via_stream() -> (wit_bindgen::rt::async_support::StreamReader<u8>,wit_bindgen::rt::async_support::FutureReader<Result<(),ErrorCode>>,){
        unsafe {
          ...
          let result4 = (wit_bindgen::rt::async_support::StreamReader::new(l2 as u32, &<u8 as super::super::super::wit_stream::StreamPayload>::VTABLE), wit_bindgen::rt::async_support::FutureReader::new(l3 as u32, &<Result<(),ErrorCode> as super::super::super::wit_future::FuturePayload>::VTABLE));
          result4
        }
      }
    ...
    pub mod stdout {
      ...
      #[allow(async_fn_in_trait)]
      pub fn write_via_stream(data: wit_bindgen::rt::async_support::StreamReader<u8>,) -> wit_bindgen::rt::async_support::FutureReader<Result<(),ErrorCode>>{
        unsafe {
          ...
          wit_bindgen::rt::async_support::FutureReader::new(ret as u32, &<Result<(),ErrorCode> as super::super::super::wit_future::FuturePayload>::VTABLE)
        }
      }
    ...
    pub mod terminal_input {
      ...
      unsafe impl _rt::WasmResource for TerminalInput{
        ...
        unsafe fn drop(_handle: u32) {
          ...
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "wasi:cli/terminal-input@0.3.0-rc-2026-03-15")]
          unsafe extern "C" {
    ...
    pub mod terminal_output {
      ...
      unsafe impl _rt::WasmResource for TerminalOutput{
        ...
        unsafe fn drop(_handle: u32) {
          ...
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "wasi:cli/terminal-output@0.3.0-rc-2026-03-15")]
          unsafe extern "C" {
    ...
    pub mod terminal_stdin {
      ...
      pub fn get_terminal_stdin() -> Option<TerminalInput>{
        unsafe {
          ...
          let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "wasi:cli/terminal-stdin@0.3.0-rc-2026-03-15")]
          unsafe extern "C" {
    ...
    pub mod terminal_stdout {
      ...
      pub fn get_terminal_stdout() -> Option<TerminalOutput>{
        unsafe {
          ...
          let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "wasi:cli/terminal-stdout@0.3.0-rc-2026-03-15")]
          unsafe extern "C" {
    ...
    pub mod terminal_stderr {
      ...
      pub fn get_terminal_stderr() -> Option<TerminalOutput>{
        unsafe {
          ...
          let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "wasi:cli/terminal-stderr@0.3.0-rc-2026-03-15")]
          unsafe extern "C" {
    ...
    pub mod system_clock {
      ...
      pub fn now() -> Instant{
        unsafe {
          ...
          let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "wasi:clocks/system-clock@0.3.0-rc-2026-03-15")]
          unsafe extern "C" {
            #[link_name = "now"]
            fn wit_import1(_: *mut u8, );
          }
    ...
    pub mod types {
      ...
      impl ::core::fmt::Debug for ErrorCode {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
          match self {
            ErrorCode::Access => {
              f.debug_tuple("ErrorCode::Access").finish()
            }
            ErrorCode::Already => {
            ...
            ErrorCode::Busy => {
              f.debug_tuple("ErrorCode::Busy").finish()
            }
            ErrorCode::Deadlock => {
              f.debug_tuple("ErrorCode::Deadlock").finish()
            }
            ErrorCode::Quota => {
              f.debug_tuple("ErrorCode::Quota").finish()
            }
            ErrorCode::Exist => {
              f.debug_tuple("ErrorCode::Exist").finish()
            }
            ...
            ErrorCode::Loop => {
              f.debug_tuple("ErrorCode::Loop").finish()
            }
            ...
            ErrorCode::NoLock => {
              f.debug_tuple("ErrorCode::NoLock").finish()
            }
            ...
            ErrorCode::NoTty => {
              f.debug_tuple("ErrorCode::NoTty").finish()
            }
      ...
      impl Descriptor {
        ...
        #[allow(async_fn_in_trait)]
        pub fn write_via_stream(&self,data: wit_bindgen::rt::async_support::StreamReader<u8>,offset: Filesize,) -> wit_bindgen::rt::async_support::FutureReader<Result<(),ErrorCode>>{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import0(_: i32, _: i32, _: i64, ) -> i32 { unreachable!() }
            let ret = wit_import0((self).handle() as i32, (&data).take_handle() as i32, _rt::as_i64(offset));
            wit_bindgen::rt::async_support::FutureReader::new(ret as u32, &<Result<(),ErrorCode> as super::super::super::wit_future::FuturePayload>::VTABLE)
          }
        }
      }
      impl Descriptor {
        ...
        #[allow(async_fn_in_trait)]
        pub fn append_via_stream(&self,data: wit_bindgen::rt::async_support::StreamReader<u8>,) -> wit_bindgen::rt::async_support::FutureReader<Result<(),ErrorCode>>{
          unsafe {
            ...
            let ret = wit_import0((self).handle() as i32, (&data).take_handle() as i32);
            wit_bindgen::rt::async_support::FutureReader::new(ret as u32, &<Result<(),ErrorCode> as super::super::super::wit_future::FuturePayload>::VTABLE)
          }
        }
      }
                    ...
                    let e = {
                      ...
                      let v6 = match l1 {
                        ...
                        n => {
                          ...
                          let e6 = {
                            let l2 = i32::from(*_ptr.add(2*::core::mem::size_of::<*const u8>()).cast::<u8>());

                            match l2 {
                              0 => None,
                              1 => {
                                let e = {
                                  let l3 = *_ptr.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                                  let l4 = *_ptr.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>();
                                  let len5 = l4;
                                  let bytes5 = _rt::Vec::from_raw_parts(l3.cast(), len5, len5);
            ...
            unsafe impl<'a> _Subtask for _MySubtask<'a> {
              ...
              unsafe fn results_lift(&mut self, _ptr: *mut u8) -> Self::Results {
                ...
                match l0 {
                  ...
                  1 => {
                    let e = {
                      let l2 = i32::from(*_ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>());
                      let v7 = match l2 {
                        0 => {
                          ErrorCode::Access
                        }
                        ...
                        n => {
                          debug_assert_eq!(n, 36, "invalid enum discriminant");
                          let e7 = {
                            let l3 = i32::from(*_ptr.add(2*::core::mem::size_of::<*const u8>()).cast::<u8>());
            ...
            unsafe impl<'a> _Subtask for _MySubtask<'a> {
              ...
              unsafe fn results_lift(&mut self, _ptr: *mut u8) -> Self::Results {
                ...
                match l0 {
                  ...
                  1 => {
                    let e = {
                      let l7 = i32::from(*_ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>());
                      let v12 = match l7 {
                        0 => {
                          ErrorCode::Access
                        }
                        ...
                        n => {
                          debug_assert_eq!(n, 36, "invalid enum discriminant");
                          let e12 = {
                            let l8 = i32::from(*_ptr.add(2*::core::mem::size_of::<*const u8>()).cast::<u8>());

                            match l8 {
                              0 => None,
                              1 => {
                                let e = {
                                  let l9 = *_ptr.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                                  let l10 = *_ptr.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>();
                                  let len11 = l10;
          ...
          unsafe {
            ...
            *mut u8, 
            ...
            unsafe impl<'a> _Subtask for _MySubtask<'a> {
              ...
              fn abi_layout(&mut self) -> ::core::alloc::Layout {
                unsafe {
                  ::core::alloc::Layout::from_size_align_unchecked((64+4*::core::mem::size_of::<*const u8>()), 8)
                }
              }
...
impl Descriptor {
  ...
  pub fn read_directory(&self,) -> (wit_bindgen::rt::async_support::StreamReader<DirectoryEntry>,wit_bindgen::rt::async_support::FutureReader<Result<(),ErrorCode>>,){
    unsafe {
      ...
      let l2 = *ptr0.add(0).cast::<i32>();
      let l3 = *ptr0.add(4).cast::<i32>();
      let result4 = (wit_bindgen::rt::async_support::StreamReader::new(l2 as u32, &<DirectoryEntry as super::super::super::wit_stream::StreamPayload>::VTABLE), wit_bindgen::rt::async_support::FutureReader::new(l3 as u32, &<Result<(),ErrorCode> as super::super::super::wit_future::FuturePayload>::VTABLE));
      result4
    }
  }
}
  ...
  pub async fn stat(&self,) -> Result<DescriptorStat,ErrorCode>{
    unsafe {
      ...
      unsafe impl<'a> _Subtask for _MySubtask<'a> {
        ...
        fn abi_layout(&mut self) -> ::core::alloc::Layout {
          unsafe {
            ::core::alloc::Layout::from_size_align_unchecked((96+4*::core::mem::size_of::<*const u8>()), 8)
          }
        }
              ...
              let e = {
                ...
                let v6 = match l1 {
                  ...
                  n => {
                    debug_assert_eq!(n, 7, "invalid enum discriminant");
                    let e6 = {
                      let l2 = i32::from(*_ptr.add(8+1*::core::mem::size_of::<*const u8>()).cast::<u8>());

                      match l2 {
                        0 => None,
                        1 => {
                          let e = {
                            let l3 = *_ptr.add(8+2*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                            let l4 = *_ptr.add(8+3*::core::mem::size_of::<*const u8>()).cast::<usize>();
                            let len5 = l4;
                            let bytes5 = _rt::Vec::from_raw_parts(l3.cast(), len5, len5);
                ...
                let l7 = *_ptr.add(8+4*::core::mem::size_of::<*const u8>()).cast::<i64>();
                let l8 = *_ptr.add(16+4*::core::mem::size_of::<*const u8>()).cast::<i64>();
                let l9 = i32::from(*_ptr.add(24+4*::core::mem::size_of::<*const u8>()).cast::<u8>());
                let l12 = i32::from(*_ptr.add(48+4*::core::mem::size_of::<*const u8>()).cast::<u8>());
                let l15 = i32::from(*_ptr.add(72+4*::core::mem::size_of::<*const u8>()).cast::<u8>());
                ...
                DescriptorStat{
                  ...
                  data_access_timestamp: match l9 {
                    ...
                    1 => {
                      let e = {
                        let l10 = *_ptr.add(32+4*::core::mem::size_of::<*const u8>()).cast::<i64>();
                        let l11 = *_ptr.add(40+4*::core::mem::size_of::<*const u8>()).cast::<i32>();
                  ...
                  data_modification_timestamp: match l12 {
                    ...
                    1 => {
                      let e = {
                        let l13 = *_ptr.add(56+4*::core::mem::size_of::<*const u8>()).cast::<i64>();
                        let l14 = *_ptr.add(64+4*::core::mem::size_of::<*const u8>()).cast::<i32>();
                  ...
                  status_change_timestamp: match l15 {
                    ...
                    1 => {
                      let e = {
                        let l16 = *_ptr.add(80+4*::core::mem::size_of::<*const u8>()).cast::<i64>();
                        let l17 = *_ptr.add(88+4*::core::mem::size_of::<*const u8>()).cast::<i32>();
              ...
              let e = {
                ...
                let v23 = match l18 {
                  ...
                  n => {
                    debug_assert_eq!(n, 36, "invalid enum discriminant");
                    let e23 = {
                      let l19 = i32::from(*_ptr.add(8+1*::core::mem::size_of::<*const u8>()).cast::<u8>());

                      match l19 {
                        0 => None,
                        1 => {
                          let e = {
                            let l20 = *_ptr.add(8+2*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                            let l21 = *_ptr.add(8+3*::core::mem::size_of::<*const u8>()).cast::<usize>();
                            let len22 = l21;
    ...
    unsafe {
      ...
      *mut u8, 
      ...
      unsafe impl<'a> _Subtask for _MySubtask<'a> {
        ...
        fn abi_layout(&mut self) -> ::core::alloc::Layout {
          unsafe {
            ::core::alloc::Layout::from_size_align_unchecked((64+6*::core::mem::size_of::<*const u8>()), 8)
          }
        }
    ...
    unsafe {
      ...
      *mut u8, 
      ...
      unsafe impl<'a> _Subtask for _MySubtask<'a> {
        ...
        fn abi_layout(&mut self) -> ::core::alloc::Layout {
          unsafe {
            ::core::alloc::Layout::from_size_align_unchecked((8+10*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>())
          }
        }
    ...
    unsafe {
      ...
      *mut u8, 
      ...
      unsafe impl<'a> _Subtask for _MySubtask<'a> {
        ...
        fn abi_layout(&mut self) -> ::core::alloc::Layout {
          unsafe {
            ::core::alloc::Layout::from_size_align_unchecked((8+8*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>())
          }
        }
        
        fn results_offset(&mut self) -> usize { (8+3*::core::mem::size_of::<*const u8>()) }
          ...
          let e = {
            ...
            let v9 = match l4 {
              ...
              n => {
                debug_assert_eq!(n, 36, "invalid enum discriminant");
                let e9 = {
                  let l5 = i32::from(*_ptr.add(2*::core::mem::size_of::<*const u8>()).cast::<u8>());

                  match l5 {
                    0 => None,
                    1 => {
                      let e = {
                        let l6 = *_ptr.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                        let l7 = *_ptr.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>();
                        let len8 = l7;
    ...
    unsafe {
      ...
      *mut u8, 
      ...
      unsafe impl<'a> _Subtask for _MySubtask<'a> {
        ...
        fn abi_layout(&mut self) -> ::core::alloc::Layout {
          unsafe {
            ::core::alloc::Layout::from_size_align_unchecked((10*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>())
          }
        }
  ...
  pub async fn metadata_hash(&self,) -> Result<MetadataHashValue,ErrorCode>{
    unsafe {
      ...
      unsafe impl<'a> _Subtask for _MySubtask<'a> {
        ...
        fn abi_layout(&mut self) -> ::core::alloc::Layout {
          unsafe {
            ::core::alloc::Layout::from_size_align_unchecked((8+4*::core::mem::size_of::<*const u8>()), 8)
          }
        }
              ...
              let e = {
                ...
                let v8 = match l3 {
                  ...
                  n => {
                    debug_assert_eq!(n, 36, "invalid enum discriminant");
                    let e8 = {
                      let l4 = i32::from(*_ptr.add(8+1*::core::mem::size_of::<*const u8>()).cast::<u8>());

                      match l4 {
                        0 => None,
                        1 => {
                          let e = {
                            let l5 = *_ptr.add(8+2*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                            let l6 = *_ptr.add(8+3*::core::mem::size_of::<*const u8>()).cast::<usize>();
                            let len7 = l6;
...
pub mod preopens {
  ...
  pub fn get_directories() -> _rt::Vec::<(Descriptor,_rt::String,)>{
    unsafe {
      ...
      let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
      #[cfg(target_arch = "wasm32")]
      #[link(wasm_import_module = "wasi:filesystem/preopens@0.3.0-rc-2026-03-15")]
      unsafe extern "C" {
  ...
  pub mod random {
    ...
    pub fn get_random_bytes(max_len: u64,) -> _rt::Vec::<u8>{
      unsafe {
        ...
        let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
        #[cfg(target_arch = "wasm32")]
        #[link(wasm_import_module = "wasi:random/random@0.3.0-rc-2026-03-15")]
        unsafe extern "C" {
  ...
  pub mod insecure {
    ...
    pub fn get_insecure_random_bytes(max_len: u64,) -> _rt::Vec::<u8>{
      unsafe {
        ...
        let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
        #[cfg(target_arch = "wasm32")]
        #[link(wasm_import_module = "wasi:random/insecure@0.3.0-rc-2026-03-15")]
        unsafe extern "C" {
  ...
  pub mod insecure_seed {
    ...
    pub fn get_insecure_seed() -> (u64,u64,){
      unsafe {
        ...
        let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
        #[cfg(target_arch = "wasm32")]
        #[link(wasm_import_module = "wasi:random/insecure-seed@0.3.0-rc-2026-03-15")]
        unsafe extern "C" {
              ...
              let e = {
                ...
                let v9 = match l4 {
                  ...
                  n => {
                    ...
                    let e9 = {
                      let l5 = i32::from(*ptr0.add(2*::core::mem::size_of::<*const u8>()).cast::<u8>());
              ...
              let e = {
                ...
                let v13 = match l8 {
                  ...
                  n => {
                    debug_assert_eq!(n, 14, "invalid enum discriminant");
                    let e13 = {
                      let l9 = i32::from(*ptr5.add(2*::core::mem::size_of::<*const u8>()).cast::<u8>());

                      match l9 {
                        0 => None,
                        1 => {
                          let e = {
                            let l10 = *ptr5.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                            let l11 = *ptr5.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>();
                            let len12 = l11;
        ...
        unsafe {
          ...
          *mut u8, 
          ...
          unsafe impl<'a> _Subtask for _MySubtask<'a> {
            ...
            fn abi_layout(&mut self) -> ::core::alloc::Layout {
              unsafe {
                ::core::alloc::Layout::from_size_align_unchecked((32+6*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>())
              }
            }
            
            fn results_offset(&mut self) -> usize { (32+1*::core::mem::size_of::<*const u8>()) }
      ...
      let result10 = match l2 {
        0 => {
          let e = {
            ...
            wit_bindgen::rt::async_support::StreamReader::new(l3 as u32, &<TcpSocket as super::super::super::wit_stream::StreamPayload>::VTABLE)
          };
          Ok(e)
        }
        1 => {
...
impl TcpSocket {
  ...
  #[allow(async_fn_in_trait)]
  pub fn send(&self,data: wit_bindgen::rt::async_support::StreamReader<u8>,) -> wit_bindgen::rt::async_support::FutureReader<Result<(),ErrorCode>>{
    unsafe {
...
impl TcpSocket {
  ...
  pub fn get_local_address(&self,) -> Result<IpSocketAddress,ErrorCode>{
    unsafe {
      ...
      #[cfg_attr(target_pointer_width="64", repr(align(8)))]
      #[cfg_attr(target_pointer_width="32", repr(align(4)))]
      struct RetArea([::core::mem::MaybeUninit::<u8>; 32+1*::core::mem::size_of::<*const u8>()]);
      let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 32+1*::core::mem::size_of::<*const u8>()]);
      let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
      #[cfg(target_arch = "wasm32")]
      #[link(wasm_import_module = "wasi:sockets/types@0.3.0-rc-2026-03-15")]
      unsafe extern "C" {
      ...
      let result27 = match l2 {
        0 => {
          let e = {
            ...
            let v20 = match l3 {
              0 => {
                let e20 = {
                  let l4 = i32::from(*ptr0.add(4+1*::core::mem::size_of::<*const u8>()).cast::<u16>());
                  let l5 = i32::from(*ptr0.add(6+1*::core::mem::size_of::<*const u8>()).cast::<u8>());
                  let l6 = i32::from(*ptr0.add(7+1*::core::mem::size_of::<*const u8>()).cast::<u8>());
                  let l7 = i32::from(*ptr0.add(8+1*::core::mem::size_of::<*const u8>()).cast::<u8>());
                  let l8 = i32::from(*ptr0.add(9+1*::core::mem::size_of::<*const u8>()).cast::<u8>());
              ...
              n => {
                ...
                let e20 = {
                  let l9 = i32::from(*ptr0.add(4+1*::core::mem::size_of::<*const u8>()).cast::<u16>());
                  let l10 = *ptr0.add(8+1*::core::mem::size_of::<*const u8>()).cast::<i32>();
                  let l11 = i32::from(*ptr0.add(12+1*::core::mem::size_of::<*const u8>()).cast::<u16>());
                  let l12 = i32::from(*ptr0.add(14+1*::core::mem::size_of::<*const u8>()).cast::<u16>());
                  let l13 = i32::from(*ptr0.add(16+1*::core::mem::size_of::<*const u8>()).cast::<u16>());
                  let l14 = i32::from(*ptr0.add(18+1*::core::mem::size_of::<*const u8>()).cast::<u16>());
                  let l15 = i32::from(*ptr0.add(20+1*::core::mem::size_of::<*const u8>()).cast::<u16>());
                  let l16 = i32::from(*ptr0.add(22+1*::core::mem::size_of::<*const u8>()).cast::<u16>());
                  let l17 = i32::from(*ptr0.add(24+1*::core::mem::size_of::<*const u8>()).cast::<u16>());
                  let l18 = i32::from(*ptr0.add(26+1*::core::mem::size_of::<*const u8>()).cast::<u16>());
                  let l19 = *ptr0.add(28+1*::core::mem::size_of::<*const u8>()).cast::<i32>();
        ...
        1 => {
          let e = {
            let l21 = i32::from(*ptr0.add(::core::mem::size_of::<*const u8>()).cast::<u8>());
            let v26 = match l21 {
              0 => {
                ErrorCode::AccessDenied
              }
              ...
              n => {
                debug_assert_eq!(n, 14, "invalid enum discriminant");
                let e26 = {
                  let l22 = i32::from(*ptr0.add(2*::core::mem::size_of::<*const u8>()).cast::<u8>());

                  match l22 {
                    0 => None,
                    1 => {
                      let e = {
                        let l23 = *ptr0.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                        let l24 = *ptr0.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>();
                        let len25 = l24;
...
impl TcpSocket {
  ...
  pub fn get_keep_alive_idle_time(&self,) -> Result<Duration,ErrorCode>{
    unsafe {
      ...
      #[repr(align(8))]
      struct RetArea([::core::mem::MaybeUninit::<u8>; 8+4*::core::mem::size_of::<*const u8>()]);
      let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 8+4*::core::mem::size_of::<*const u8>()]);
      let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
      #[cfg(target_arch = "wasm32")]
      #[link(wasm_import_module = "wasi:sockets/types@0.3.0-rc-2026-03-15")]
      unsafe extern "C" {
              ...
              n => {
                ...
                let e9 = {
                  ...
                  match l5 {
                    ...
                    1 => {
                      let e = {
                        let l6 = *ptr0.add(8+2*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                        let l7 = *ptr0.add(8+3*::core::mem::size_of::<*const u8>()).cast::<usize>();
                        let len8 = l7;
                        let bytes8 = _rt::Vec::from_raw_parts(l6.cast(), len8, len8);
    ...
    unsafe {
      ...
      *mut u8, 
      ...
      unsafe impl<'a> _Subtask for _MySubtask<'a> {
        ...
        fn abi_layout(&mut self) -> ::core::alloc::Layout {
          unsafe {
            ::core::alloc::Layout::from_size_align_unchecked((32+9*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>())
          }
        }
        
        fn results_offset(&mut self) -> usize { (32+4*::core::mem::size_of::<*const u8>()) }
              ...
              let e = {
                ...
                let v27 = match l22 {
                  ...
                  n => {
                    debug_assert_eq!(n, 14, "invalid enum discriminant");
                    let e27 = {
                      let l23 = i32::from(*_ptr.add(2*::core::mem::size_of::<*const u8>()).cast::<u8>());

                      match l23 {
                        0 => None,
                        1 => {
                          let e = {
                            let l24 = *_ptr.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                            let l25 = *_ptr.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>();
                            let len26 = l25;
      ...
      *mut u8, usize, 
      ...
      unsafe impl<'a> _Subtask for _MySubtask<'a> {
        ...
        unsafe fn call_import(&mut self, _params: Self::ParamsLower, _results: *mut u8) -> u32 {
          ...
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "wasi:sockets/ip-name-lookup@0.3.0-rc-2026-03-15")]
          unsafe extern "C" {
          ...
          let e = {
            ...
            let v23 = match l18 {
              ...
              n => {
                ...
                let e23 = {
                  let l19 = i32::from(*_ptr.add(2*::core::mem::size_of::<*const u8>()).cast::<u8>());

                  match l19 {
                    0 => None,
                    1 => {
                      let e = {
                        let l20 = *_ptr.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                        let l21 = *_ptr.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>();
                        let len22 = l21;
                        let bytes22 = _rt::Vec::from_raw_parts(l20.cast(), len22, len22);
...
pub mod exports {
  pub mod streamkit {
    pub mod plugin {
      ...
      pub mod node {
        ...
        pub type NodeMetadata = super::super::super::super::streamkit::plugin::types::NodeMetadata;
        ...
        impl NodeInstance{
          ...
          pub fn new<T: GuestNodeInstance>(val: T) -> Self {
            ...
            let ptr: *mut _NodeInstanceRep<T> =
        ...
        impl<'a> NodeInstanceBorrow<'a>{
          ...
          pub fn get<T: GuestNodeInstance>(&self) -> &'a T {
            let ptr = unsafe { &mut *self.as_ptr::<T>() };
            ptr.as_ref().unwrap()
          }
        ...
        unsafe impl _rt::WasmResource for NodeInstance{
          ...
          unsafe fn drop(_handle: u32) {
            ...
            #[cfg(target_arch = "wasm32")]
            #[link(wasm_import_module = "[export]streamkit:plugin/node@0.2.0")]
            unsafe extern "C" {
        ...
        pub unsafe fn _export_metadata_cabi<T_: Guest>() -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
        _rt::run_ctors_once();let result0 = {
          T_::metadata()
        };
        let ptr1 = (&raw mut _RET_AREA.0).cast::<u8>();
        let super::super::super::super::streamkit::plugin::types::NodeMetadata{ kind:kind2, inputs:inputs2, outputs:outputs2, param_schema:param_schema2, categories:categories2, } = result0;
        ...
        for (i, e) in vec10.into_iter().enumerate() {
          let base = result10.add(i * (4*::core::mem::size_of::<*const u8>()));
          {
            ...
            *base.add(0).cast::<*mut u8>() = ptr5.cast_mut();
            ...
            let len9 = vec9.len();
            let layout9 = _rt::alloc::Layout::from_size_align(vec9.len() * (3*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>()).unwrap();
            let (result9, _cleanup9) = wit_bindgen::rt::Cleanup::new(layout9);if let Some(cleanup) = _cleanup9 { cleanup.forget(); }
            for (i, e) in vec9.into_iter().enumerate() {
              let base = result9.add(i * (3*::core::mem::size_of::<*const u8>()));
              {
                ...
                match e {
                  V8::RawAudio(e) => {
                    ...
                    *base.add(::core::mem::size_of::<*const u8>()).cast::<i32>() = _rt::as_i32(sample_rate6);
                    *base.add(4+1*::core::mem::size_of::<*const u8>()).cast::<u16>() = (_rt::as_i32(channels6)) as u16;
                    *base.add(6+1*::core::mem::size_of::<*const u8>()).cast::<u8>() = (sample_format6.clone() as i32) as u8;
                  },
                  V8::OpusAudio=> {
                    {
            ...
            *base.add(2*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = result9;
          }
        }
        *ptr1.add(3*::core::mem::size_of::<*const u8>()).cast::<usize>() = len10;
        *ptr1.add(2*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = result10;
        let vec16 = outputs2;
        let len16 = vec16.len();
        let layout16 = _rt::alloc::Layout::from_size_align(vec16.len() * (5*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>()).unwrap();
            ...
            *base.add(0).cast::<*mut u8>() = ptr12.cast_mut();
            ...
            match produces_type11 {
              V15::RawAudio(e) => {
                ...
                *base.add(3*::core::mem::size_of::<*const u8>()).cast::<i32>() = _rt::as_i32(sample_rate13);
                *base.add(4+3*::core::mem::size_of::<*const u8>()).cast::<u16>() = (_rt::as_i32(channels13)) as u16;
                *base.add(6+3*::core::mem::size_of::<*const u8>()).cast::<u8>() = (sample_format13.clone() as i32) as u8;
              },
              V15::OpusAudio=> {
                {
        ...
        *ptr1.add(4*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = result16;
        let vec17 = (param_schema2.into_bytes()).into_boxed_slice();
        let ptr17 = vec17.as_ptr().cast::<u8>();
        let len17 = vec17.len();
        ::core::mem::forget(vec17);
        *ptr1.add(7*::core::mem::size_of::<*const u8>()).cast::<usize>() = len17;
        *ptr1.add(6*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr17.cast_mut();
        ...
        *ptr1.add(8*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = result19;
        ptr1
      } }
      #[doc(hidden)]
      #[allow(non_snake_case)]
      pub unsafe fn __post_return_metadata<T_: Guest>(arg0: *mut u8,) { unsafe {
        ...
        let l13 = *arg0.add(4*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
        let l14 = *arg0.add(5*::core::mem::size_of::<*const u8>()).cast::<usize>();
        let base20 = l13;
        let len20 = l14;
        for i in 0..len20 {
          let base = base20.add(i * (5*::core::mem::size_of::<*const u8>()));
          {
            ...
            let l17 = i32::from(*base.add(2*::core::mem::size_of::<*const u8>()).cast::<u8>());
            match l17 {
              0 => (),
              1 => (),
              2 => (),
              3 => (),
              4 => {
                let l18 = *base.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l19 = *base.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>();
        ...
        _rt::cabi_dealloc(base20, len20 * (5*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>());
        let l21 = *arg0.add(6*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
        let l22 = *arg0.add(7*::core::mem::size_of::<*const u8>()).cast::<usize>();
        _rt::cabi_dealloc(l21, l22, 1);
        let l23 = *arg0.add(8*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
        let l24 = *arg0.add(9*::core::mem::size_of::<*const u8>()).cast::<usize>();
        let base27 = l23;
        let len27 = l24;
        for i in 0..len27 {
      ...
      #[doc(hidden)]
      #[allow(non_snake_case, unused_unsafe)]
      pub unsafe fn _export_constructor_node_instance_cabi<T_: GuestNodeInstance>(arg0: i32,arg1: *mut u8,arg2: usize,) -> i32 { unsafe {#[cfg(target_arch="wasm32")]
      _rt::run_ctors_once();let result1 = {
        NodeInstance::new(T_::new(match arg0 {
          0 => None,
          1 => {
            let e = {
              let len0 = arg2;
    ...
    #[doc(hidden)]
    #[allow(non_snake_case, unused_unsafe)]
    pub unsafe fn _export_method_node_instance_process_cabi<T_: GuestNodeInstance>(arg0: *mut u8,arg1: *mut u8,arg2: usize,arg3: i32,arg4: *mut u8,arg5: usize,arg6: *mut u8,arg7: *mut u8,arg8: usize,) -> i32 { unsafe {#[cfg(target_arch="wasm32")]
    _rt::run_ctors_once();wit_bindgen::rt::async_support::start_task(async move {
      ...
      let result7 = &{
        ...
        let v6 = match arg3 {
          0 => {
            let e6 = {
              ...
              super::super::super::super::streamkit::plugin::types::AudioFrame{
                ...
                samples: <_ as From<_rt::Vec<_>>>::from(_rt::Vec::from_raw_parts(arg6.cast(), len1, len1)),
              }
            };
            V6::Audio(e6)
          }
          ...
          2 => {
            let e6 = {
              ...
              <_ as From<_rt::Vec<_>>>::from(_rt::Vec::from_raw_parts(arg4.cast(), len3, len3))
            };
            V6::Binary(e6)
          }
          n => {
            ...
            let e6 = {
              let len4 = arg5;
              let bytes4 = _rt::Vec::from_raw_parts(arg4.cast(), len4, len4);
              let len5 = arg8;
              let bytes5 = _rt::Vec::from_raw_parts(arg7.cast(), len5, len5);
        ...
        T_::process(NodeInstanceBorrow::lift(arg0 as u32 as usize).get(), _rt::string_lift(bytes0), v6).await
      };
      ...
      #[link(wasm_import_module = "[export]streamkit:plugin/node@0.2.0")]
      unsafe extern "C" {
        #[link_name = "[task-return][method]node-instance.process"]
        fn wit_import10(_: i32, _: *mut u8, _: usize, );
      }

      #[cfg(not(target_arch = "wasm32"))]
      unsafe extern "C" fn wit_import10(_: i32, _: *mut u8, _: usize, ) { unreachable!() }
      _task_cancel.forget();
      wit_import10(result9_0, result9_1, result9_2);
    })
  } }
  #[doc(hidden)]
  #[allow(non_snake_case)]
  pub unsafe fn __callback_method_node_instance_process(event0: u32, event1: u32, event2: u32) -> u32 {
    unsafe {
  ...
  #[doc(hidden)]
  #[allow(non_snake_case, unused_unsafe)]
  pub unsafe fn _export_method_node_instance_update_params_cabi<T_: GuestNodeInstance>(arg0: *mut u8,arg1: i32,arg2: *mut u8,arg3: usize,) -> i32 { unsafe {#[cfg(target_arch="wasm32")]
  _rt::run_ctors_once();wit_bindgen::rt::async_support::start_task(async move {
    let _task_cancel = wit_bindgen::rt::async_support::TaskCancelOnDrop::new();
    let result1 = &{
      T_::update_params(NodeInstanceBorrow::lift(arg0 as u32 as usize).get(), match arg1 {
        0 => None,
        1 => {
          let e = {
            let len0 = arg3;
    ...
    #[link(wasm_import_module = "[export]streamkit:plugin/node@0.2.0")]
    unsafe extern "C" {
      #[link_name = "[task-return][method]node-instance.update-params"]
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __callback_method_node_instance_update_params(event0: u32, event1: u32, event2: u32) -> u32 {
  unsafe {
    wit_bindgen::rt::async_support::callback(event0, event1, event2)
  }
}
#[doc(hidden)]
#[allow(non_snake_case, unused_unsafe)]
pub unsafe fn _export_method_node_instance_cleanup_cabi<T_: GuestNodeInstance>(arg0: *mut u8,) { unsafe {#[cfg(target_arch="wasm32")]
_rt::run_ctors_once();{
  T_::cleanup(NodeInstanceBorrow::lift(arg0 as u32 as usize).get())
};
} }
pub trait Guest {
...
pub trait GuestNodeInstance: 'static {
  ...
  #[allow(async_fn_in_trait)]
  async fn process(&self,input_pin: _rt::String,packet: Packet,) -> Result<(),_rt::String>;
  /// Update the runtime parameters for this instance. The payload is a JSON string.
  #[allow(async_fn_in_trait)]
  async fn update_params(&self,params: Option<_rt::String>,) -> Result<(),_rt::String>;
...
#[doc(hidden)]
#[macro_export]
macro_rules! __export_streamkit_plugin_node_0_2_0_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

    #[unsafe(export_name = "streamkit:plugin/node@0.2.0#metadata")]
    unsafe extern "C" fn export_metadata() -> *mut u8 {
      unsafe { $($path_to_types)*::_export_metadata_cabi::<$ty>() }
    }
    #[unsafe(export_name = "cabi_post_streamkit:plugin/node@0.2.0#metadata")]
    unsafe extern "C" fn _post_return_metadata(arg0: *mut u8,) {
      unsafe { $($path_to_types)*::__post_return_metadata::<$ty>(arg0) }
    }
    #[unsafe(export_name = "streamkit:plugin/node@0.2.0#[constructor]node-instance")]
    ...
    #[unsafe(export_name = "[async-lift]streamkit:plugin/node@0.2.0#[method]node-instance.process")]
    unsafe extern "C" fn export_method_node_instance_process(arg0: *mut u8,arg1: *mut u8,arg2: usize,arg3: i32,arg4: *mut u8,arg5: usize,arg6: *mut u8,arg7: *mut u8,arg8: usize,) -> i32 {
    ...
    #[unsafe(export_name = "[callback][async-lift]streamkit:plugin/node@0.2.0#[method]node-instance.process")]
    unsafe extern "C" fn _callback_method_node_instance_process(event0: u32, event1: u32, event2: u32) -> u32 {
      unsafe {
        $($path_to_types)*::__callback_method_node_instance_process(event0, event1, event2)
      }
    }
    #[unsafe(export_name = "[async-lift]streamkit:plugin/node@0.2.0#[method]node-instance.update-params")]
    unsafe extern "C" fn export_method_node_instance_update_params(arg0: *mut u8,arg1: i32,arg2: *mut u8,arg3: usize,) -> i32 {
    ...
    #[unsafe(export_name = "[callback][async-lift]streamkit:plugin/node@0.2.0#[method]node-instance.update-params")]
    unsafe extern "C" fn _callback_method_node_instance_update_params(event0: u32, event1: u32, event2: u32) -> u32 {
      unsafe {
        $($path_to_types)*::__callback_method_node_instance_update_params(event0, event1, event2)
      }
    }
    #[unsafe(export_name = "streamkit:plugin/node@0.2.0#[method]node-instance.cleanup")]
    ...
    const _: () = {
      #[doc(hidden)]
      #[unsafe(export_name = "streamkit:plugin/node@0.2.0#[dtor]node-instance")]
      #[allow(non_snake_case)]
...
#[doc(hidden)]
pub use __export_streamkit_plugin_node_0_2_0_cabi;
...
pub mod wit_future {
  ...
  pub mod vtable1 {
      ...
      1 => {
        let e = {
          ...
          let v6 = match l1 {
            ...
            21 => {
              V6::InsufficientMemory
            }
            22 => {
              V6::InsufficientSpace
            }
            23 => {
              V6::NotDirectory
            }
            ...
            n => {
              debug_assert_eq!(n, 36, "invalid enum discriminant");
              let e6 = {
                let l2 = i32::from(*ptr.add(2*::core::mem::size_of::<*const u8>()).cast::<u8>());

                match l2 {
                  0 => None,
                  1 => {
                    let e = {
                      let l3 = *ptr.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                      let l4 = *ptr.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>();
                      let len5 = l4;
                      let bytes5 = super::super::_rt::Vec::from_raw_parts(l3.cast(), len5, len5);
      ...
      Err(e) => { {
        *ptr.add(0).cast::<u8>() = (1i32) as u8;
        ...
        match e {
          V1::Access=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (0i32) as u8;
            }
          }
          V1::Already=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (1i32) as u8;
            }
          }
          V1::BadDescriptor=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (2i32) as u8;
            }
          }
          V1::Busy=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (3i32) as u8;
            }
          }
          V1::Deadlock=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (4i32) as u8;
            }
          }
          V1::Quota=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (5i32) as u8;
            }
          }
          V1::Exist=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (6i32) as u8;
            }
          }
          V1::FileTooLarge=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (7i32) as u8;
            }
          }
          V1::IllegalByteSequence=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (8i32) as u8;
            }
          }
          V1::InProgress=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (9i32) as u8;
            }
          }
          V1::Interrupted=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (10i32) as u8;
            }
          }
          V1::Invalid=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (11i32) as u8;
            }
          }
          V1::Io=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (12i32) as u8;
            }
          }
          V1::IsDirectory=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (13i32) as u8;
            }
          }
          V1::Loop=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (14i32) as u8;
            }
          }
          V1::TooManyLinks=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (15i32) as u8;
            }
          }
          V1::MessageSize=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (16i32) as u8;
            }
          }
          V1::NameTooLong=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (17i32) as u8;
            }
          }
          V1::NoDevice=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (18i32) as u8;
            }
          }
          V1::NoEntry=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (19i32) as u8;
            }
          }
          V1::NoLock=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (20i32) as u8;
            }
          }
          V1::InsufficientMemory=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (21i32) as u8;
            }
          }
          V1::InsufficientSpace=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (22i32) as u8;
            }
          }
          V1::NotDirectory=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (23i32) as u8;
            }
          }
          V1::NotEmpty=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (24i32) as u8;
            }
          }
          V1::NotRecoverable=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (25i32) as u8;
            }
          }
          V1::Unsupported=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (26i32) as u8;
            }
          }
          V1::NoTty=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (27i32) as u8;
            }
          }
          V1::NoSuchDevice=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (28i32) as u8;
            }
          }
          V1::Overflow=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (29i32) as u8;
            }
          }
          V1::NotPermitted=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (30i32) as u8;
            }
          }
          V1::Pipe=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (31i32) as u8;
            }
          }
          V1::ReadOnly=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (32i32) as u8;
            }
          }
          V1::InvalidSeek=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (33i32) as u8;
            }
          }
          V1::TextFileBusy=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (34i32) as u8;
            }
          }
          V1::CrossDevice=> {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (35i32) as u8;
            }
          }
          V1::Other(e) => {
            *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (36i32) as u8;
            match e {
              Some(e) => {
                *ptr.add(2*::core::mem::size_of::<*const u8>()).cast::<u8>() = (1i32) as u8;
                let vec0 = (e.into_bytes()).into_boxed_slice();
                let ptr0 = vec0.as_ptr().cast::<u8>();
                let len0 = vec0.len();
                ::core::mem::forget(vec0);
                *ptr.add(4*::core::mem::size_of::<*const u8>()).cast::<usize>() = len0;
                *ptr.add(3*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr0.cast_mut();
              },
              None => {
                {
                  *ptr.add(2*::core::mem::size_of::<*const u8>()).cast::<u8>() = (0i32) as u8;
                }
              },
            };},
          }
    ...
    pub static VTABLE: wit_bindgen::rt::async_support::FutureVtable<Result<(),super::super::wasi::filesystem::types::ErrorCode>> = wit_bindgen::rt::async_support::FutureVtable::<Result<(),super::super::wasi::filesystem::types::ErrorCode>> {
      ...
      dealloc_lists,
      layout: unsafe {
        ::core::alloc::Layout::from_size_align_unchecked(20, 4)
      },
      lift,
      lower,
      new,
      ...
      1 => {
        let e = {
          ...
          let v6 = match l1 {
            ...
            6 => {
              V6::AddressNotBindable
            }
            7 => {
              V6::AddressInUse
            }
            8 => {
              V6::RemoteUnreachable
            }
            9 => {
              V6::ConnectionRefused
            }
            10 => {
              V6::ConnectionBroken
            }
...
pub mod wit_stream {
  ...
  pub mod vtable1 {
      ...
      n => {
        ...
        let e5 = {
          ...
          match l1 {
            ...
            1 => {
              let e = {
                let l2 = *ptr.add(2*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l3 = *ptr.add(3*::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len4 = l3;
                let bytes4 = super::super::_rt::Vec::from_raw_parts(l2.cast(), len4, len4);
    ...
    let l6 = *ptr.add(4*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
    let l7 = *ptr.add(5*::core::mem::size_of::<*const u8>()).cast::<usize>();
    let len8 = l7;
    let bytes8 = super::super::_rt::Vec::from_raw_parts(l6.cast(), len8, len8);
    ...
    match type_0 {
        ...
        match e {
          Some(e) => {
            *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (1i32) as u8;
            ...
            let len1 = vec1.len();
            ::core::mem::forget(vec1);
            *ptr.add(3*::core::mem::size_of::<*const u8>()).cast::<usize>() = len1;
            *ptr.add(2*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr1.cast_mut();
          },
          None => {
            {
              *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (0i32) as u8;
      ...
      *ptr.add(4*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr3.cast_mut();
    } }
    unsafe fn dealloc_lists(ptr: *mut u8) { unsafe { let l0 = i32::from(*ptr.add(0).cast::<u8>());
    match l0 {
      0 => (),
    ...
    let l4 = *ptr.add(4*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
    let l5 = *ptr.add(5*::core::mem::size_of::<*const u8>()).cast::<usize>();
  ...
  pub static VTABLE: wit_bindgen::rt::async_support::StreamVtable<super::super::wasi::filesystem::types::DirectoryEntry> = wit_bindgen::rt::async_support::StreamVtable::<super::super::wasi::filesystem::types::DirectoryEntry> {
    ...
    layout: unsafe {
      ::core::alloc::Layout::from_size_align_unchecked(24, 4)
    },
    lift: Some(lift),
    lower: Some(lower),
    new,
...
macro_rules! __export_plugin_impl {
  ...
  $($path_to_types_root)*::exports::streamkit::plugin::node::__export_streamkit_plugin_node_0_2_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::streamkit::plugin::node);
  const _: () = {

    #[cfg(target_arch = "wasm32")]
    #[unsafe(link_section = "component-type:wit-bindgen:0.58.0:streamkit:plugin@0.2.0:plugin:imports and exports")]
    #[doc(hidden)]
    #[allow(clippy::octal_escapes)]
    pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 9244] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x9fG\x01A\x02\x01A9\x01\
...
\0\x06packet\x03\0\x18\x03\0\x1cstreamkit:plugin/types@0.2.0\x05\0\x02\x03\0\0\x06\
packet\x01B\x09\x02\x03\x02\x01\x01\x04\0\x06packet\x03\0\0\x01m\x04\x05debug\x04\
info\x04warn\x05error\x04\0\x09log-level\x03\0\x02\x01j\0\x01s\x01C\x02\x08pin-n\
ames\x06packet\x01\0\x04\x04\0\x0bsend-output\x01\x05\x01@\x02\x05level\x03\x07m\
essages\x01\0\x04\0\x03log\x01\x06\x03\0\x1bstreamkit:plugin/host@0.2.0\x05\x02\x01\
...
cwd\x01\x06\x03\0(wasi:cli/environment@0.3.0-rc-2026-03-15\x05\x03\x01B\x03\x01j\
\0\0\x01@\x01\x06status\0\x01\0\x04\0\x04exit\x01\x01\x03\0!wasi:cli/exit@0.3.0-\
rc-2026-03-15\x05\x04\x01B\x02\x01m\x03\x02io\x15illegal-byte-sequence\x04pipe\x04\
\0\x0aerror-code\x03\0\0\x03\0\"wasi:cli/types@0.3.0-rc-2026-03-15\x05\x05\x02\x03\
\0\x04\x0aerror-code\x01B\x08\x02\x03\x02\x01\x06\x04\0\x0aerror-code\x03\0\0\x01\
f\x01}\x01j\0\x01\x01\x01e\x01\x03\x01o\x02\x02\x04\x01@\0\0\x05\x04\0\x0fread-v\
ia-stream\x01\x06\x03\0\"wasi:cli/stdin@0.3.0-rc-2026-03-15\x05\x07\x01B\x07\x02\
\x03\x02\x01\x06\x04\0\x0aerror-code\x03\0\0\x01f\x01}\x01j\0\x01\x01\x01e\x01\x03\
\x01@\x01\x04data\x02\0\x04\x04\0\x10write-via-stream\x01\x05\x03\0#wasi:cli/std\
out@0.3.0-rc-2026-03-15\x05\x08\x01B\x07\x02\x03\x02\x01\x06\x04\0\x0aerror-code\
\x03\0\0\x01f\x01}\x01j\0\x01\x01\x01e\x01\x03\x01@\x01\x04data\x02\0\x04\x04\0\x10\
write-via-stream\x01\x05\x03\0#wasi:cli/stderr@0.3.0-rc-2026-03-15\x05\x09\x01B\x01\
\x04\0\x0eterminal-input\x03\x01\x03\0+wasi:cli/terminal-input@0.3.0-rc-2026-03-\
15\x05\x0a\x01B\x01\x04\0\x0fterminal-output\x03\x01\x03\0,wasi:cli/terminal-out\
put@0.3.0-rc-2026-03-15\x05\x0b\x02\x03\0\x08\x0eterminal-input\x01B\x06\x02\x03\
\x02\x01\x0c\x04\0\x0eterminal-input\x03\0\0\x01i\x01\x01k\x02\x01@\0\0\x03\x04\0\
\x12get-terminal-stdin\x01\x04\x03\0+wasi:cli/terminal-stdin@0.3.0-rc-2026-03-15\
\x05\x0d\x02\x03\0\x09\x0fterminal-output\x01B\x06\x02\x03\x02\x01\x0e\x04\0\x0f\
terminal-output\x03\0\0\x01i\x01\x01k\x02\x01@\0\0\x03\x04\0\x13get-terminal-std\
out\x01\x04\x03\0,wasi:cli/terminal-stdout@0.3.0-rc-2026-03-15\x05\x0f\x01B\x06\x02\
...
26-03-15\x05\x10\x01B\x02\x01w\x04\0\x08duration\x03\0\0\x03\0%wasi:clocks/types\
@0.3.0-rc-2026-03-15\x05\x11\x02\x03\0\x0d\x08duration\x01B\x0c\x02\x03\x02\x01\x12\
...
\x07\x03\0/wasi:clocks/monotonic-clock@0.3.0-rc-2026-03-15\x05\x13\x01B\x08\x02\x03\
\x02\x01\x12\x04\0\x08duration\x03\0\0\x01r\x02\x07secondsx\x0bnanosecondsy\x04\0\
\x07instant\x03\0\x02\x01@\0\0\x03\x04\0\x03now\x01\x04\x01@\0\0\x01\x04\0\x0ege\
t-resolution\x01\x05\x03\0,wasi:clocks/system-clock@0.3.0-rc-2026-03-15\x05\x14\x02\
\x03\0\x0f\x07instant\x01BZ\x02\x03\x02\x01\x15\x04\0\x07instant\x03\0\0\x01w\x04\
...
pes@0.3.0-rc-2026-03-15\x05\x16\x02\x03\0\x10\x0adescriptor\x01B\x07\x02\x03\x02\
\x01\x17\x04\0\x0adescriptor\x03\0\0\x01i\x01\x01o\x02\x02s\x01p\x03\x01@\0\0\x04\
\x04\0\x0fget-directories\x01\x05\x03\0,wasi:filesystem/preopens@0.3.0-rc-2026-0\
3-15\x05\x18\x01Br\x02\x03\x02\x01\x12\x04\0\x08duration\x03\0\0\x01ks\x01q\x0f\x0d\
...
s@0.3.0-rc-2026-03-15\x05\x19\x02\x03\0\x12\x0aip-address\x01B\x09\x02\x03\x02\x01\
\x1a\x04\0\x0aip-address\x03\0\0\x01ks\x01q\x06\x0daccess-denied\0\0\x10invalid-\
...
\x03\0/wasi:sockets/ip-name-lookup@0.3.0-rc-2026-03-15\x05\x1b\x01B\x05\x01p}\x01\
@\x01\x07max-lenw\0\0\x04\0\x10get-random-bytes\x01\x01\x01@\0\0w\x04\0\x0eget-r\
andom-u64\x01\x02\x03\0&wasi:random/random@0.3.0-rc-2026-03-15\x05\x1c\x01B\x05\x01\
...
26-03-15\x05\x1d\x01B\x03\x01o\x02ww\x01@\0\0\0\x04\0\x11get-insecure-seed\x01\x01\
\x03\0-wasi:random/insecure-seed@0.3.0-rc-2026-03-15\x05\x1e\x02\x03\0\0\x0dnode\
-metadata\x01B\x13\x02\x03\x02\x01\x1f\x04\0\x0dnode-metadata\x03\0\0\x02\x03\x02\
\x01\x01\x04\0\x06packet\x03\0\x02\x04\0\x0dnode-instance\x03\x01\x01ks\x01i\x04\
\x01@\x01\x06params\x05\0\x06\x04\0\x1a[constructor]node-instance\x01\x07\x01h\x04\
\x01j\0\x01s\x01C\x03\x04self\x08\x09input-pins\x06packet\x03\0\x09\x04\0\x1d[me\
thod]node-instance.process\x01\x0a\x01C\x02\x04self\x08\x06params\x05\0\x09\x04\0\
#[method]node-instance.update-params\x01\x0b\x01@\x01\x04self\x08\x01\0\x04\0\x1d\
[method]node-instance.cleanup\x01\x0c\x01@\0\0\x01\x04\0\x08metadata\x01\x0d\x04\
\0\x1bstreamkit:plugin/node@0.2.0\x05\x20\x04\0\x1dstreamkit:plugin/plugin@0.2.0\
\x04\0\x0b\x0c\x01\0\x06plugin\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0d\
wit-component\x070.251.0\x10wit-bindgen-rust\x060.58.0";
  };
  )
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.58.0:streamkit:plugin@0.2.0:plugin-with-all-of-its-exports-removed:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 8952] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xdbD\x01A\x02\x01A6\x01\
B\x1a\x01m\x02\x07float32\x06s16-le\x04\0\x0dsample-format\x03\0\0\x01r\x03\x0bs\
ample-ratey\x08channels{\x0dsample-format\x01\x04\0\x0caudio-format\x03\0\x02\x01\
q\x06\x09raw-audio\x01\x03\0\x0aopus-audio\0\0\x04text\0\0\x06binary\0\0\x06cust\
om\x01s\0\x03any\0\0\x04\0\x0bpacket-type\x03\0\x04\x01m\x01\x04json\x04\0\x0fcu\
...
\x04\0\x17get-insecure-random-u64\x01\x02\x03\0(wasi:random/insecure@0.3.0-rc-20\
26-03-15\x05\x1d\x01B\x03\x01o\x02ww\x01@\0\0\0\x04\0\x11get-insecure-seed\x01\x01\
\x03\0-wasi:random/insecure-seed@0.3.0-rc-2026-03-15\x05\x1e\x04\0=streamkit:plu\
gin/plugin-with-all-of-its-exports-removed@0.2.0\x04\0\x0b,\x01\0&plugin-with-al\
l-of-its-exports-removed\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-\
component\x070.251.0\x10wit-bindgen-rust\x060.58.0";
