                ...
                unsafe {
                    ...
                    unsafe impl<'a> _Subtask for _MySubtask<'a> {
                        ...
                        unsafe fn params_lower(
                            ...
                            unsafe {
                                use super::super::super::streamkit::plugin::types::Packet as V7;
                                match _lower1 {
                                    V7::Audio(e) => {
                                        ...
                                        *_param_ptr
                                            .add(::core::mem::size_of::<*const u8>())
                                            .cast::<i32>() = _rt::as_i32(sample_rate0);
                                        *_param_ptr
                                            .add(4 + 1 * ::core::mem::size_of::<*const u8>())
                                            .cast::<u16>() = (_rt::as_i32(channels0)) as u16;
                                        let vec1 = <_ as Into<_rt::Vec<_>>>::into(samples0)
                                            .into_boxed_slice();
                                    ...
                                    V7::Binary(e) => {
                                        *_param_ptr.add(0).cast::<u8>() = (2i32) as u8;
                                        let vec3 =
                                            <_ as Into<_rt::Vec<_>>>::into(e).into_boxed_slice();
                                    ...
                                    V7::Custom(e) => {
                                        ...
                                        *_param_ptr
                                            .add(3 * ::core::mem::size_of::<*const u8>())
                                            .cast::<u8>() = (encoding4.clone() as i32) as u8;
            ...
            pub async fn wait_until(when: Mark) -> () {
                unsafe {
                    ...
                    unsafe impl<'a> _Subtask for _MySubtask<'a> {
                        ...
                        type ParamsLower = ParamsLower;
                        fn abi_layout(&mut self) -> ::core::alloc::Layout {
                            unsafe { ::core::alloc::Layout::from_size_align_unchecked(0, 1) }
                        }
        ...
        pub mod system_clock {
            ...
            pub fn now() -> Instant {
                unsafe {
                    ...
                    let result4 = Instant { seconds: l2, nanoseconds: l3 as u32 };
                    result4
                }
            }
            #[allow(unused_unsafe, clippy::all)]
            ...
            impl ::core::fmt::Debug for ErrorCode {
                fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                    match self {
                        ...
                        ErrorCode::InProgress => f.debug_tuple("ErrorCode::InProgress").finish(),
                        ErrorCode::Interrupted => f.debug_tuple("ErrorCode::Interrupted").finish(),
                        ErrorCode::Invalid => f.debug_tuple("ErrorCode::Invalid").finish(),
                        ErrorCode::Io => f.debug_tuple("ErrorCode::Io").finish(),
                        ErrorCode::IsDirectory => f.debug_tuple("ErrorCode::IsDirectory").finish(),
                        ErrorCode::Loop => f.debug_tuple("ErrorCode::Loop").finish(),
                        ErrorCode::TooManyLinks => {
                            f.debug_tuple("ErrorCode::TooManyLinks").finish()
                        },
                        ErrorCode::MessageSize => f.debug_tuple("ErrorCode::MessageSize").finish(),
                        ErrorCode::NameTooLong => f.debug_tuple("ErrorCode::NameTooLong").finish(),
                        ...
                        ErrorCode::Unsupported => f.debug_tuple("ErrorCode::Unsupported").finish(),
                        ...
                        ErrorCode::InvalidSeek => f.debug_tuple("ErrorCode::InvalidSeek").finish(),
                        ErrorCode::TextFileBusy => {
                            f.debug_tuple("ErrorCode::TextFileBusy").finish()
                        },
                        ErrorCode::CrossDevice => f.debug_tuple("ErrorCode::CrossDevice").finish(),
                        ErrorCode::Other(e) => f.debug_tuple("ErrorCode::Other").field(e).finish(),
                    }
                }
            }
            ...
            impl Descriptor {
                ...
                pub async fn advise(
                    ...
                    unsafe {
                        ...
                        _MySubtask { _unused: core::marker::PhantomData }
                    ...
                    unsafe {
                        ...
                        unsafe impl<'a> _Subtask for _MySubtask<'a> {
                            ...
                            unsafe fn call_import(
                                ...
                                #[cfg(not(target_arch = "wasm32"))]
                                unsafe extern "C" fn call(_: i32, _: i64, _: *mut u8) -> i32 {
                                    unreachable!()
                                }
                    ...
                    unsafe {
                        ...
                        unsafe impl<'a> _Subtask for _MySubtask<'a> {
                            ...
                            unsafe fn params_lower(
                                ...
                                let _param_ptr = unsafe { _ptr.add(0) };
                                unsafe {
                                    *_param_ptr.add(0).cast::<i32>() = (_lower0).handle() as i32;
                                }
                                ...
                                unsafe {
                                    match _lower1 {
                                        ...
                                        NewTimestamp::Timestamp(e) => {
                                            ...
                                            *_param_ptr.add(8).cast::<i64>() =
                                                _rt::as_i64(seconds0);
                                            *_param_ptr.add(16).cast::<i32>() =
                        ...
                        _MySubtask { _unused: core::marker::PhantomData }
                            .call((self, data_access_timestamp, data_modification_timestamp))
                            .await
                    }
                }
            }
                    ...
                    unsafe {
                        ...
                        unsafe impl<'a> _Subtask for _MySubtask<'a> {
                            ...
                            unsafe fn params_lower(
                                ...
                                unsafe {
                                    let flags0 = _lower1;
                                    *_param_ptr.add(0).cast::<u8>() =
                                        ((flags0.bits() >> 0) as i32) as u8;
                                }
                                let _param_ptr = unsafe { _ptr.add(8) };
                                unsafe {
                    ...
                    unsafe {
                        ...
                        unsafe impl<'a> _Subtask for _MySubtask<'a> {
                            ...
                            unsafe fn params_lower(
                                ...
                                unsafe {
                                    *_param_ptr.add(0).cast::<i32>() = (_lower3).handle() as i32;
                                }
                                let _param_ptr = unsafe {
                        ...
                        _MySubtask { _unused: core::marker::PhantomData }
                            .call((self, old_path_flags, old_path, new_descriptor, new_path))
                            .await
                    }
                }
            }
            ...
            impl Descriptor {
                ...
                pub async fn rename_at(
                    ...
                    unsafe {
                        ...
                        unsafe impl<'a> _Subtask for _MySubtask<'a> {
                            type Params =
                                (&'a Descriptor, _rt::String, &'a Descriptor, _rt::String);
                            type Results = Result<(), ErrorCode>;
                            type ParamsLower = ParamsLower;
                            fn abi_layout(&mut self) -> ::core::alloc::Layout {
                                unsafe {
                            ...
                            unsafe fn params_lower(
                                ...
                                let _param_ptr =
                                    unsafe { _ptr.add(::core::mem::size_of::<*const u8>()) };
                                unsafe {
                                    let vec0 = (_lower1.into_bytes()).into_boxed_slice();
                                    let ptr0 = vec0.as_ptr().cast::<u8>();
                                    let len0 = vec0.len();
                                ...
                                unsafe {
                                    *_param_ptr.add(0).cast::<i32>() = (_lower2).handle() as i32;
                                }
                                let _param_ptr =
                                    unsafe { _ptr.add((4 * ::core::mem::size_of::<*const u8>())) };
                                unsafe {
                ...
                pub async fn is_same_object(&self, other: &Descriptor) -> bool {
                    unsafe {
                        ...
                        unsafe impl<'a> _Subtask for _MySubtask<'a> {
                            ...
                            type ParamsLower = ParamsLower;
                            fn abi_layout(&mut self) -> ::core::alloc::Layout {
                                unsafe { ::core::alloc::Layout::from_size_align_unchecked(1, 1) }
                            }
        ...
        pub mod random {
            ...
            pub fn get_random_bytes(max_len: u64) -> _rt::Vec<u8> {
                unsafe {
                    ...
                    let l3 = *ptr0.add(::core::mem::size_of::<*const u8>()).cast::<usize>();
                    let len4 = l3;
                    let result5 = <_ as From<_rt::Vec<_>>>::from(_rt::Vec::from_raw_parts(
                        l2.cast(),
                        len4,
                        len4,
                    ));
            ...
            impl ::core::fmt::Debug for ErrorCode {
                fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                    match self {
                        ...
                        ErrorCode::OutOfMemory => f.debug_tuple("ErrorCode::OutOfMemory").finish(),
                                ...
                                unsafe {
                                    match _lower1 {
                                        IpSocketAddress::Ipv4(e) => {
                                            ...
                                            *_param_ptr.add(4).cast::<u16>() =
                                                (_rt::as_i32(port0)) as u16;
                                            let (t1_0, t1_1, t1_2, t1_3) = address0;
                                            *_param_ptr.add(6).cast::<u8>() =
                                                (_rt::as_i32(t1_0)) as u8;
                                            *_param_ptr.add(7).cast::<u8>() =
                                                (_rt::as_i32(t1_1)) as u8;
                                            *_param_ptr.add(8).cast::<u8>() =
                                                (_rt::as_i32(t1_2)) as u8;
                                            *_param_ptr.add(9).cast::<u8>() =
                                        ...
                                        IpSocketAddress::Ipv6(e) => {
                                            ...
                                            *_param_ptr.add(8).cast::<i32>() =
                                                _rt::as_i32(flow_info2);
                                            let (t3_0, t3_1, t3_2, t3_3, t3_4, t3_5, t3_6, t3_7) =
                                                address2;
                                            *_param_ptr.add(12).cast::<u16>() =
                                                (_rt::as_i32(t3_0)) as u16;
                                            *_param_ptr.add(14).cast::<u16>() =
                                                (_rt::as_i32(t3_1)) as u16;
                                            *_param_ptr.add(16).cast::<u16>() =
                                                (_rt::as_i32(t3_2)) as u16;
                                            *_param_ptr.add(18).cast::<u16>() =
                                                (_rt::as_i32(t3_3)) as u16;
                                            *_param_ptr.add(20).cast::<u16>() =
                                                (_rt::as_i32(t3_4)) as u16;
                                            *_param_ptr.add(22).cast::<u16>() =
                                                (_rt::as_i32(t3_5)) as u16;
                                            *_param_ptr.add(24).cast::<u16>() =
                                                (_rt::as_i32(t3_6)) as u16;
                                            *_param_ptr.add(26).cast::<u16>() =
                                                (_rt::as_i32(t3_7)) as u16;
                                            *_param_ptr.add(28).cast::<i32>() =
                                                _rt::as_i32(scope_id2);
                                        },
                                    }
                                }
                                    ...
                                    let v20 = match l3 {
                                        ...
                                        n => {
                                            ...
                                            let e20 = {
                                                ...
                                                let l19 = *ptr0
                                                    .add(
                                                        28 + 1 * ::core::mem::size_of::<*const u8>(
                                                        ),
                                                    )
                                                    .cast::<i32>();
                                                ...
                                                Ipv6SocketAddress {
                                                    ...
                                                    address: (
                                                        ...
                                                        l14 as u16, l15 as u16, l16 as u16,
                                                        l17 as u16, l18 as u16,
                                                    ),
                                                    scope_id: l19 as u32,
                                                }
                                            };
                    ...
                    unsafe {
                        ...
                        unsafe impl<'a> _Subtask for _MySubtask<'a> {
                            ...
                            unsafe fn params_lower(
                                ...
                                unsafe {
                                    let vec0 =
                                        <_ as Into<_rt::Vec<_>>>::into(_lower1).into_boxed_slice();
                                    let ptr0 = vec0.as_ptr().cast::<u8>();
                                    let len0 = vec0.len();
                                    ::core::mem::forget(vec0);
                                    *_param_ptr
                                            ...
                                            *_param_ptr.add(0).cast::<u8>() = (1i32) as u8;
                                            match e {
                                                IpSocketAddress::Ipv4(e) => {
                                                    ...
                                                    *_param_ptr.add(8).cast::<u16>() =
                                                        (_rt::as_i32(port0)) as u16;
                                                    let (t1_0, t1_1, t1_2, t1_3) = address0;
                                                    *_param_ptr.add(10).cast::<u8>() =
                                                        (_rt::as_i32(t1_0)) as u8;
                                                    *_param_ptr.add(11).cast::<u8>() =
                                                        (_rt::as_i32(t1_1)) as u8;
                                                    *_param_ptr.add(12).cast::<u8>() =
                                                        (_rt::as_i32(t1_2)) as u8;
                                                    *_param_ptr.add(13).cast::<u8>() =
                                                        (_rt::as_i32(t1_3)) as u8;
                                                },
                                                IpSocketAddress::Ipv6(e) => {
                                                    ...
                                                    *_param_ptr.add(26).cast::<u16>() =
                                                        (_rt::as_i32(t3_5)) as u16;
                                                    *_param_ptr.add(28).cast::<u16>() =
                                                        (_rt::as_i32(t3_6)) as u16;
                                                    *_param_ptr.add(30).cast::<u16>() =
                                                        (_rt::as_i32(t3_7)) as u16;
                                                    *_param_ptr.add(32).cast::<i32>() =
                                                        _rt::as_i32(scope_id2);
                                                },
                                            }
                                        },
                                                    ...
                                                    n => {
                                                        ...
                                                        let e21 = {
                                                            ...
                                                            Ipv6SocketAddress {
                                                                ...
                                                                address: (
                                                                    l12 as u16, l13 as u16,
                                                                    l14 as u16, l15 as u16,
                                                                    l16 as u16, l17 as u16,
                                                                    l18 as u16, l19 as u16,
                                                                ),
                                                                scope_id: l20 as u32,
                                                            }
                                                        };
    ...
    pub mod streamkit {
        pub mod plugin {
            ...
            pub mod node {
                ...
                pub unsafe fn _export_metadata_cabi<T_: Guest>() -> *mut u8 {
                    unsafe {
                        #[cfg(target_arch = "wasm32")]
                        _rt::run_ctors_once();
                        let result0 = { T_::metadata() };
                        ...
                        *ptr1.add(0).cast::<*mut u8>() = ptr3.cast_mut();
                        ...
                        .unwrap();
                        let (result10, _cleanup10) = wit_bindgen::rt::Cleanup::new(layout10);
                        ...
                        *ptr1.add(6 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>() =
                        ...
                        .unwrap();
                        let (result19, _cleanup19) = wit_bindgen::rt::Cleanup::new(layout19);
                ...
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_constructor_node_instance_cabi<T_: GuestNodeInstance>(
                    arg0: i32,
                    arg1: *mut u8,
                    arg2: usize,
                ) -> i32 {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_method_node_instance_process_cabi<T_: GuestNodeInstance>(
                    arg0: *mut u8,
                    arg1: *mut u8,
                    arg2: usize,
                    arg3: i32,
                ...
                data: _rt::string_lift(bytes5),
                            ...
                            #[cfg(not(target_arch = "wasm32"))]
                            unsafe extern "C" fn wit_import10(_: i32, _: *mut u8, _: usize) {
                                unreachable!()
                            }
                            _task_cancel.forget();
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __callback_method_node_instance_process(
                    event0: u32,
                    event1: u32,
                    event2: u32,
                ) -> u32 {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __callback_method_node_instance_update_params(
                    event0: u32,
                    event1: u32,
                    event2: u32,
                ) -> u32 {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_method_node_instance_cleanup_cabi<T_: GuestNodeInstance>(
                    arg0: *mut u8,
                ) {
                    unsafe {
                        #[cfg(target_arch = "wasm32")]
...
pub mod wit_future {
    ...
    pub mod vtable0 {
        ...
        unsafe fn lift(ptr: *mut u8) -> Result<(), super::super::wasi::cli::stdin::ErrorCode> {
            unsafe {
                ...
                match l0 {
                    ...
                    _ => {
                        ...
                        match l1 {
                            ...
                            _ => {
                                let l2 = i32::from(
                                    *ptr.add(2 * ::core::mem::size_of::<*const u8>()).cast::<u8>(),
                                );
                                match l2 {
                                    0 => (),
                                    _ => {
    ...
    pub mod vtable2 {
        ...
        unsafe fn lift(ptr: *mut u8) -> Result<(), super::super::wasi::sockets::types::ErrorCode> {
            unsafe {
                let l0 = i32::from(*ptr.add(0).cast::<u8>());
...
pub mod wit_stream {
    ...
    pub mod vtable1 {
        ...
        unsafe fn lift(ptr: *mut u8) -> super::super::wasi::filesystem::types::DirectoryEntry {
            unsafe {
                let l0 = i32::from(*ptr.add(0).cast::<u8>());
        ...
        unsafe fn lower(
            ...
            unsafe {
                        ...
                        match e {
                            Some(e) => {
                                *ptr.add(::core::mem::size_of::<*const u8>()).cast::<u8>() =
                                ...
                                let len1 = vec1.len();
                                ::core::mem::forget(vec1);
                                *ptr.add(3 * ::core::mem::size_of::<*const u8>()).cast::<usize>() =
                                    len1;
                                *ptr.add(2 * ::core::mem::size_of::<*const u8>())
                                    .cast::<*mut u8>() = ptr1.cast_mut();
                            },
                ...
                *ptr.add(4 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>() =
                    ptr3.cast_mut();
            }
        }
        unsafe fn dealloc_lists(ptr: *mut u8) {
    ...
    pub mod vtable2 {
        ...
        unsafe fn lower(value: super::super::wasi::sockets::types::TcpSocket, ptr: *mut u8) {
            unsafe {
