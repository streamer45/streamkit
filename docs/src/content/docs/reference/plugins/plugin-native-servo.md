...
| `custom_css` | `string` | no | — | Optional CSS applied at three lifecycle triggers: first paint, after the post-paint settle period, and load-complete |
...
```json
{
  ...
  "properties": {
    ...
    "custom_css": { "type": "string", "description": "Optional CSS applied at three lifecycle triggers: first paint, after the post-paint settle period, and load-complete", "tunable": true },
