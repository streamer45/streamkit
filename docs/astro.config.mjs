			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Installing Plugins', slug: 'guides/installing-plugins' },
						...
						{ label: 'Publishing Plugins', slug: 'guides/publishing-plugins' },
						{ label: 'Model Downloads', slug: 'guides/model-downloads' },
